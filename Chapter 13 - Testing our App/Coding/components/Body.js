...
const Body = () => {
  ...
  return listOfRestaurants === null ? (
    ...
    <div className="body bg-slate-50">
        ...
        <div className="search m-3 px-2">
          ...
          >
            <div className="flex items-center justify-center">
              ...
              <span className="px-2 font-bold">Search</span>
            </div>
          </button>
        </div>
        <div>
          <button
            className="filter-btn mr-4 p-2 bg-slate-300 rounded-md hover:shadow-md"
            onClick={() => {
              //this is a callback function that runs when we click the button
              //Filter logic:
      ...
      <div className="m-4 p-4 font-bold text-xl">Welcome {loggedInUser},</div>
