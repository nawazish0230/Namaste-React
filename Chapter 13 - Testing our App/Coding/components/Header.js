    ...
    <div className="flex justify-between text-stone-50 font-bold shadow-lg z-10 sticky top-0 relative bg-red-600 md:bg-red-700 dark:bg-slate-900">
      ...
      <div className="nav-items flex ">
        <ul className="flex m-4 p-4 items-center">
          <li className="m-4 px-2 text-lg">
            Online Status: {onlineStatus ? "🟢" : "😡"}
          </li>
          <li
            className="m-4 px-2 text-lg hover:cursor-pointer hover:bg-red-900 p-2 rounded-md"
            onClick={OnModeClickHandler}
          >
            Mode
          </li>
          <Link to="/">
            <li className="m-4 px-2 text-lg hover:bg-red-900  p-2 rounded-md">
              Home
            </li>
          </Link>
          <Link to="/about">
